...
<body class="style-default style-rounded error404">
  ...
  <h2 align="center">All articles</h2>
   <table class="table table-hover">
    ...
    <?php                          $sql = "SELECT * FROM article ORDER BY Article_id  DESC";
...
?>
    <tbody>
      <tr>
        <td><?php echo $rws["Author"] ?></td>
        <td><?php echo $rws["Theme"] ?></td>
        <td><?php echo $rws["Category"] ?></td>
        <td><?php echo $rws["Data_published"] ?></td>
      </tr>
    </tbody>                                 <?php } }
