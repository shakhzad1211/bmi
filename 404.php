...
<head>
    ...
    <meta name="description" content="Content-Type:css/text">
                        ...
                        <div class="nav__right">
                            ...
                            <div class="nav__right-item nav__search">
                                <form role="search" action="search-result.php" method="post" class="search-form relative">
                                    <input type="search" class="widget-search-input mb-0" name="search1" placeholder="Search an article">
                    ...
                    <div class="row justify-content-center mt-40">
                        ...
                        <div class="col-md-6">
                            ...
                            <form role="search" method="post" action="search-result.php" class="search-form relative">
                                <input type="search" class="widget-search-input mb-0" name=search1 placeholder="Search an article">
                                <button type="submit" class="widget-search-button name=submit btn btn-color"><i class="ui-search widget-search-icon"></i></button>
                            </form>
