                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <ul class="contact-items">
                            <li class="contact-item"><address>National institute Fine arts and design after named Kamoliddin Behzod</address></li>
                            <li class="contact-item"><a href="tel:+ 998 71 255 96 91">+ 998 (71) 255 18 92</a></li>
