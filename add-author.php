        ...
        <div class="main-container container pt-80 pb-80" id="main-container">
            ...
            <div class="blog__content mb-72">
                ...
                <input type="Degree" name="Degree" placeholder="Degree">
                        ...
                        <br>
            <button type="submit" class="btn btn-primary" data-style="zoom-in" value="Upload" id="SubmitButton" name="add-author">Add article</button>            <script src="js/ckeditor.js"></script>
