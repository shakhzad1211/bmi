...
<body class="style-default style-rounded error404">
    ...
    <main class="main oh" id="main">
        ...
        <div class="main-container container pt-80 pb-80" id="main-container">
            <!-- post content -->
            <div class="container">
                <h2 align="center">All articles</h2>
            ...
            if(isset($_REQUEST['submit'])){
                $Res=$_REQUEST['search1'];
            

            $sql = "SELECT * FROM article WHERE CONCAT(Author, '', Article_text, '', Category,'',Theme) LIKE '%".$_POST['search1']."%'";
       ...
       while($rws = $result->fetch_assoc()) {
          ?>                <tr>                       
                                ...
                                <td> <a href="single-post.php?tema=<?php echo $rws['Article_id'] ?>"><?php echo $rws["Author"] ?></a></td>
                                <td><a href="single-post.php?tema=<?php echo $rws['Article_id'] ?>"><?php echo $rws["Theme"] ?></a></td>
                                <td><a href="single-post.php?tema=<?php echo $rws['Article_id'] ?>"><?php echo $rws['Data_published'] ?></a></td>
                                <td><a href="single-post.php?tema=<?php echo $rws['Article_id'] ?>"><?php echo $rws['Category'] ?></a></td>
