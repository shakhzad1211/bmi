...
<!-- onmousedown='return false;'    onselectstart='return false;' -->
 ...
 $ddd=$_GET['avtor'];
                         ...
                         $sql = "SELECT * FROM author where Author_id ='".$ddd."' ";
          ...
          ?>
                            <div class="single-post__entry-header entry__header">
                                <h1 class="single-post__entry-title">
                                    <?php echo $rws['FName'] ?> <?php echo $rws["LName"] ?> </h1>
                                ...
                                <article class="post-list-small__entry clearfix" style="padding-bottom: 4px;">
                                    <div class="post-list-small__img-holder">
                                        <div class="thumb-container thumb-100">
                                            <a href="single-post.php?tema=<?php echo $rws['Theme'] ?>">
                                    ...
                                    <div class="post-list-small__body">
                                        <h3 class="post-list-small__entry-title">
                                            <a href="single-post.php?tema=<?php echo $rws['Theme'] ?>"><?php echo $rws["Theme"] ?></a>
                                        </h3>
                                        <ul class="entry__meta">
                                            <li class="entry__meta-author">
                                                <span>by</span>
                                                <a href="author-rewiew.php?avtor=<?php echo $rws['Author'] ?>"><?php echo $rws["Author"] ?></a>
                                            </li>
