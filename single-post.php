...
<body class="bg-light single-post style-default style-rounded"  onmousedown='return false;'    onselectstart='return false;'>
...
<!-- Preloader -->
 ...
 $ddd=$_GET['tema'];
                         ...
                         $sql = "SELECT * FROM article where Article_id ='".$ddd."' ";
          ...
          ?>
                            <div class="single-post__entry-header entry__header">
                                <a href="category-rewiew.php?category=<?php echo $rws['Category']?>"
                                    class="entry__meta-category entry__meta-category--label entry__meta-category--green"><?php echo $rws['Category'] ?></a>
                                <h1 class="single-post__entry-title">
                                    <?php echo $rws['Theme'] ?> </h1>
