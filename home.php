...
<?php 
    ...
    include '_database/database.php';
        ...
        // $sql = "SELECT * FROM admins where FName=`$_GET`";
...
<body class="style-default style-rounded error404">
    ...
    <main class="main oh" id="main">
        ...
        <header class="nav">
                ...
                <span class="nav-icon-toggle__inner"></span>
                        ...
                        <a href="index.php" class="logo">
                            <img style="padding-top:3px" class="logo__img" src="img/logo-3.png"
                                srcset="img/logo-3.png 1x, img/logo-3.png " alt="logo">
                        </a>
            ...
            <div class="menus" align="center" style="margin:20px;">
            <a href="add-article.php" style="margin:2%;" class="btn btn-lg btn-light mt-40"><span>Add Article</span></a>
            <a href="add-author.php" style="margin:4%;" class="btn btn-lg btn-light mt-40"><span>Add Author</span></a><br>
            <a href="all-articles.php" style="margin:2%;" class="btn btn-lg btn-light mt-40"><span>All Articles</span></a>
            <a href="all-authors.php" style="margin:4%;" class="btn btn-lg btn-light mt-40"><span>All Authors</span></a><br>
               <a href="components/logout.php" class="btn btn-lg btn-light mt-40"><span> Log out</span></a>
