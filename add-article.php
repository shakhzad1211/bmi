...
?>
                    ...
                    include '_database/database.php';
                     ...
                     while($rws = $result->fetch_assoc()) {
                     ?>
                            <option value="<?php echo $rws['FName']?><?php echo $rws['LName'] ?>">
                                <?php echo $rws['FName'] ?><?php echo $rws['LName'] ?>
                            </option>
                            <?php } }
...
?>
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" data-style="zoom-in" value="Upload"
                            id="SubmitButton" name="add-article">Add article</button>
